...
public class ForgetPassword extends JPanel
{
	...
	public ForgetPassword()
	{
		...
		JLabel labelPage = new JLabel("Mot de passe oublié", SwingConstants.CENTER);
		JLabel labelId = new JLabel("Identifiant", SwingConstants.RIGHT);
		fieldId = new JTextField();
		JLabel labelPassword = new JLabel("Nouveau mot de passe", SwingConstants.RIGHT);
		fieldPassword = new JPasswordField();
		JLabel labelPasswordVerif = new JLabel("Confirmer le nouveau mot de passe", SwingConstants.RIGHT);
		...
		labelPassword.setBounds(xMiddle - 250, 510, 150, 30);
		fieldPassword.setBounds(xMiddle - 90, 510, 250, 30);
		labelPasswordVerif.setBounds(xMiddle - 350, 550, 250, 30);
		...
		Action actionConfirm = new AbstractAction()
		{
			...
			{
				VerifUser.forgetPassword(fieldDate.getText(), fieldId.getText(), fieldPassword.getText(), fieldPasswordVerif.getText());
			}
		};
